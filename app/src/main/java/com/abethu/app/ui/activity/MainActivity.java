...
import com.abethu.app.ui.fragment.ComingSoonFragment;
import com.abethu.app.util.download.NavigateToScreenEvent;
...
import com.abethu.app.model.Support;
...
import com.abethu.app.network.events.APIEvent;
import com.abethu.app.ui.fragment.DownloadsFragment;
import com.abethu.app.ui.fragment.SearchFragment;
import com.abethu.app.ui.fragment.SettingsFragment;
import com.abethu.app.ui.fragment.VideoContentFragment;
import com.abethu.app.util.ConfigParser;
...
import static com.abethu.app.network.APIConstants.APIs.GETHELPQUERIES;
import static com.abethu.app.network.APIConstants.APIs.GET_APP_RATING;
import static com.abethu.app.network.APIConstants.APIs.GET_APP_RATING_UPDATE;
import static com.abethu.app.network.APIConstants.APIs.GET_SERVER_APP_VERSION;
...
import static com.abethu.app.network.APIConstants.Params.NAME;
...
import static com.abethu.app.network.APIConstants.Params.SHARE_TYPE_INSTALL;
...
import static com.abethu.app.network.APIConstants.Params.TYPE;
import static com.abethu.app.network.APIConstants.Params.VERSION_CODE;
import static com.abethu.app.ui.activity.VideoPageActivity.ACTION_DOWNLOAD_UPDATE;
...
import static com.abethu.app.util.sharedpref.PrefKeys.SERVER_APP_VERSION;
import static com.abethu.app.util.sharedpref.PrefKeys.UPDATE_APP_COMPULSORY;
import static com.abethu.app.util.sharedpref.PrefKeys.USER_ID;
...
public class MainActivity extends BaseActivity implements View.OnClickListener, DownloadCompleteListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        llComingSoon.setOnClickListener(this);
...
/*        LinearLayout.LayoutParams param = new LinearLayout.LayoutParams(0,LinearLayout.LayoutParams.MATCH_PARENT);
    ...
    public void navigateToComingSoonScreen() {
    ...
    public void downloadCompleted(int adminVideoId) {
        ...
        //intent.putExtra(DownloadsFragment.CANCELLED_OR_COMPLETED, cancelledOrCompleted);
