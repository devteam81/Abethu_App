...
import static com.abethu.app.ui.activity.MainActivity.SERVER_VERSION_CODE;
import static com.abethu.app.ui.activity.MainActivity.SERVER_VERSION_NAME;
import static com.abethu.app.ui.activity.MainActivity.SHOW_UPDATE_BUTTON;
...
//        app_version.setText(BuildConfig.VERSION_NAME);
    ...
    @OnClick({R.id.checkNetworkTile, R.id.speedTestTile, R.id.rl_download_validity})
