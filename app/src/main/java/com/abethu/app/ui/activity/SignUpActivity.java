...
public class SignUpActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        terms_Privacy.setSpan(new ForegroundColorSpan(getColor(R.color.colorAccent)), 31, 36, 0);
        terms_Privacy.setSpan(new ForegroundColorSpan(getColor(R.color.colorAccent)), 41, 55, 0);
