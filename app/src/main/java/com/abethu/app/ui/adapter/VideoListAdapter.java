...
import static com.abethu.app.network.APIConstants.APIs.CLEAR_HISTORY;
import static com.abethu.app.network.APIConstants.APIs.CLEAR_SPAM_LIST;
import static com.abethu.app.network.APIConstants.APIs.CLEAR_WISH_LIST;
import static com.abethu.app.network.APIConstants.APIs.SEARCH_VIDEOS;
...
import static com.abethu.app.ui.activity.VideoPageActivity.trailerPlaying;
...
public class VideoListAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof VideoViewHolder) {
            ...
            Video singleItem = videos.get(position);
            ...
            if(position%2==0) {
                holder.layout.setBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.season_bg1,null));
            } else {
                holder.layout.setBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.season_bg2,null));
            }
