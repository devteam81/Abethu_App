...
import com.abethu.app.ui.activity.PassCodeCreateActivity;
import com.abethu.app.ui.activity.WebViewActivity;
import com.abethu.app.ui.adapter.AgeAdapter;
import com.abethu.app.ui.adapter.BannerAdapter;
import com.abethu.app.ui.adapter.VideoSectionsAdapter;
import com.abethu.app.util.CarouselEffectTransformer;
import com.abethu.app.util.FixedSpeedScroller;
...
import com.abethu.app.util.database.DatabaseClient;
...
import static com.abethu.app.network.APIConstants.APIs.HOME_SLIDER;
...
import static com.abethu.app.network.APIConstants.Constants.PAGE_TYPE;
import static com.abethu.app.network.APIConstants.Params;
import static com.abethu.app.network.APIConstants.Params.CATEGORY_ID;
...
import static com.abethu.app.network.APIConstants.Params.GENRE_ID;
import static com.abethu.app.network.APIConstants.Params.PARENT_MEDIA;
import static com.abethu.app.network.APIConstants.Params.SLIDER_TYPE;
import static com.abethu.app.network.APIConstants.Params.SUB_CATEGORY_ID;
...
import static com.abethu.app.ui.activity.MainActivity.skipLock;
import static com.abethu.app.util.ParserUtils.parseVideoSections;
import static com.abethu.app.util.sharedpref.PrefKeys.SUBSCRIPTION_DAYS;
...
//        viewPager.setPageMargin(-80);
        ...
        viewPager.setPageTransformer(false, new CarouselEffectTransformer(getActivity()));
        ...
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        PendingIntent pendingIntent = PendingIntent.getActivity(getActivity(), 0, intent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void showTermsPrivacyPopup()
    {
        ...
        terms_Condition.setSpan(new ForegroundColorSpan(activity.getColor(R.color.colorPrimaryLight)), 13, 31, 0);
        ...
        terms_Privacy.setSpan(new ForegroundColorSpan(activity.getColor(R.color.colorPrimaryLight)), 4, 18, 0);
    ...
    public void showAgePicker()
    {
        ...
        terms_Privacy.setSpan(new ForegroundColorSpan(activity.getColor(R.color.colorPrimaryLight)), 12, 31, 0);
...
//    }
    ...
    private void getVideoSections() {
        ...
        Log.d("getVideoSections_test", "getVideoSections: 1  "+prefUtils.getIntValue(PrefKeys.USER_ID, 1));
        Log.d("getVideoSections_test", "getVideoSections: 2  "+prefUtils.getStringValue(PrefKeys.SESSION_TOKEN, ""));
        Log.d("getVideoSections_test", "getVideoSections: 3  "+prefUtils.getIntValue(PrefKeys.ACTIVE_SUB_PROFILE, 0));
        Log.d("getVideoSections_test", "getVideoSections: 4  "+pageType);
        Log.d("getVideoSections_test", "getVideoSections: 5  "+categoryId);
        Log.d("getVideoSections_test", "getVideoSections: 6  "+subCategoryId);
        Log.d("getVideoSections_test", "getVideoSections: 7  "+genreId);
        Log.d("getVideoSections_test", "getVideoSections: 8  "+prefUtils.getStringValue(PrefKeys.APP_LANGUAGE_STRING, ""));
        Log.d("getVideoSections_test", "getVideoSections: 9  "+CURRENT_IP);
        Log.d("getVideoSections_test", "getVideoSections: 10  "+BuildConfig.VERSION_NAME);
        Log.d("getVideoSections_test", "getVideoSections: 11  "+BuildConfig.VERSION_CODE);
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (!isAdded()) return;
                Log.d("onResponse_testg", "onResponse: "+response.body());
                UiUtils.hideLoadingDialog();
                contentView.setVisibility(View.VISIBLE);
                ...
                if (homeResponse != null) {
                    ...
                    if (homeResponse.optString(Params.SUCCESS).equals(Constants.TRUE)) {
                        ...
                        Log.d("onResponse_test", "onResponse: "+homeResponse);
                    } else {
